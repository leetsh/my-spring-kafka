...
public class MessageListener {
    ...
    static CountDownLatch partitionLatch = new CountDownLatch(2);

    static CountDownLatch filterLatch = new CountDownLatch(2);

    static CountDownLatch greetingLatch = new CountDownLatch(1);
